...
*/
adicionarPessoas = function(x)
{
    var assentoDisponivel = carro.assentos - carro.quantidadePessoas;
    var pessoas = 'pessoas';
    if (x <= assentoDisponivel)
    {
      carro.quantidadePessoas += x;
    }
  if ( assentoDisponivel === 0 )
  {
    return 'O carro já está lotado!';
  }
  if ( assentoDisponivel !== 0 && x > assentoDisponivel ) 
  {
    if (assentoDisponivel === 1)
    {
      pessoas = 'pessoa';
    }
    return 'Só cabem mais ' + assentoDisponivel + ' ' + pessoas;
  } 
...
obterMarcaModelo(); // "Esse carro é um Fiat Toro"
...
tirarPessoas = function(x)
{
  carro.quantidadePessoas = carro.quantidadePessoas - x;
  return 'Já temos ' + carro.quantidadePessoas + ' pessoas no carro!';
}
tirarPessoas(4); // "Já temos 1 pessoas no carro!"
