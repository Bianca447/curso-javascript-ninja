...
*/
nomeCompleto(); // Olá! Meu nome é Bianca Santos!

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
mostrarIdade(); // Olá, eu tenho 23 anos!

/*
Qual o peso da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
mostrarPeso(); // Eu peso 69Kg.

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
mostrarAltura(); // Minha altura é 1.69m.
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // Olá, eu sou a Bianca Santos, tenho 26 anos, 1.69, meu peso é 69 e, só hoje, eu já caminhei 18 metros!
```
